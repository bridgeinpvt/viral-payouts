      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <Sparkles
                className={`h-8 w-8 ${selectedRole === UserRole.CREATOR ? 'text-primary' : 'text-muted-foreground'}`}
              />
              <span
                className={`text-sm font-medium ${selectedRole === UserRole.CREATOR ? 'text-primary' : ''}`}
              >
                Creator
              </span>
              <span className="text-xs text-muted-foreground text-center">
                Earn by promoting brands
              </span>
            </button>
            <button
              type="button"
            ...
            >
              <Building2
                className={`h-8 w-8 ${selectedRole === UserRole.BRAND ? 'text-primary' : 'text-muted-foreground'}`}
              />
              <span
                className={`text-sm font-medium ${selectedRole === UserRole.BRAND ? 'text-primary' : ''}`}
              >
                Brand
              </span>
              <span className="text-xs text-muted-foreground text-center">
