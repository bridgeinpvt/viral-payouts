...
async function main() {
  ...
  const viewCampaign = await prisma.campaign.create({
    data: {
      ...
      description:
        'Promote our new tech product launch through engaging video content',
      type: 'VIEW',
      productName: 'Smart Widget Pro',
      campaignBrief:
        'Create engaging video content showcasing our new Smart Widget Pro',
      contentGuidelines:
        'Videos should be 30-60 seconds, highlight key features',
  ...
  const conversionCampaign = await prisma.campaign.create({
    data: {
      ...
      campaignBrief:
        'Promote our new fashion collection with exclusive discount codes',
      contentGuidelines:
        'Create posts featuring the collection with your promo code',
  ...
  await prisma.notification.create({
    data: {
      ...
      message:
        'Your participation in Tech Product Launch campaign has been approved',
      isRead: false,
