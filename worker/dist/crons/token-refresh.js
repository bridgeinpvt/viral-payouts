...
exports.startTokenRefreshCron = startTokenRefreshCron;
...
async function refreshInstagramTokens() {
    ...
    const creators = await db_1.db.creatorProfile.findMany({
        where: {
    ...
    for (const creator of creators) {
        ...
        try {
            ...
            url.searchParams.append("access_token", creator.instagramAccessToken);
            ...
            if (data && data.access_token) {
                await db_1.db.creatorProfile.update({
